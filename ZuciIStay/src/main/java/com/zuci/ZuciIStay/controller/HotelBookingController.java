...
public class HotelBookingController {
    ...
    @GetMapping("/booking")
    public boolean roomBookingByCheck(@RequestBody BookingData bookingData, HttpServletRequest request) {
        String authHeader = request.getHeader("Authorization");
        System.out.println(authHeader);
        String token = null;
        String username = null;
        ...
        return hotelBookingService.roomBookingByCheck(bookingData,username);
    }
